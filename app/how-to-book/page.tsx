      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="divide-y divide-slate-200">
          ...
          >
            ...
            <Tips
              ...
              items={[
                ...
                "ถ้าเข้าสู่ระบบด้วย LINE ไว้ กดปุ่มแนบสลิปในข้อความที่ส่งเข้าแชทได้เลย ไม่ต้องหาลิงก์เอง",
              ]}
            />
          </Section>
          ...
          >
            <CustomerStatusFlow />
            <p>
              ถ้าคุณ<b>เข้าสู่ระบบด้วย LINE</b> ทุกครั้งที่สถานะเปลี่ยนจะมีข้อความเข้าแชททันที
