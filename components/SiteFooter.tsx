    ...
    <footer className="mt-auto border-t border-slate-200 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid gap-8 sm:grid-cols-3">
          <div>
            <Brand href={null} size="md" subtitle="เช่ารถเชียงใหม่" className="mb-3" />
            <p className="text-sm text-slate-500 leading-relaxed">
              ภูพิงค์ คอร์ปอเรชั่น จำกัด — บริการเช่ารถคุณภาพในเชียงใหม่
              รถสะอาด ราคาชัดเจน จองออนไลน์ได้ตลอด 24 ชั่วโมง
            </p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 text-xs text-slate-400">
          © {new Date().getFullYear()} PHUPING CORPORATION CO., LTD.
        </div>
      </div>
    </footer>
  );
